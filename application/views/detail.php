					  ...
					  <div class="single-para ">
						 <h4><?php echo $detail->movie_name?></h4>							
							...
							<div class="prdt-info-grid">
                                 ...
                                 <br>Kuota : <?php echo $detail->quota?>
							</div>
							<?php $quota = $detail->quota;
                              if($quota != 0){?>
							<a href="<?php echo base_url('home/book/')?><?php echo $detail->id_movie?>/<?php echo $detail->price?>" class="add-cart item_add">Booking Now!</a>			<?php 
                                             }
                          ?>				
					 </div>
				 </div>
                 ...
                 <form action="<?php echo base_url('home/add_comment/')?><?php echo $detail->id_movie?>" method="post">
                    ...
                    <div class="col-md-7">
                     ...
                     <?php
                            ...
                            <div class="col-md-7">
                                <h4>Sorry, You cant comment before booking</h4>
				            </div>
                        <?php
                             }
                    ?>
